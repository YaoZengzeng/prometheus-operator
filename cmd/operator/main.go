...
func init() {
	...
	// specified.
	// 可以在初始配置中设定prometheus-config-reloader，prometheus-default-base-image以及config-reload-image的信息
	...
	// ManagerCRDs为true，表明由Prometheus Operator管理所有的CRDs
	// Operator会自动对各个CRD进行创建
